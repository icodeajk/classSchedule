  ...
  <div style='height:100%'>
    ...
    <div class="title">
      <header-switch>
        ...
        <mt-search v-model="searchVal" slot="center" class="inner-search" cancel-text="取消" placeholder="请输入经营范围">
        </mt-search>
      </header-switch>
            ...
            <baseinfo-card v-for="(value, index) in data" :key="index" :item="value">
              <div slot="bottom" class="list-bottom">
                <div class="bottom-left">
                  <img src="@/assets/img/icon-business.png" class="bottom-img"/>
                </div>
                <div class="bottom-right zan-ellipsis--l2">
                  <span>经营范围：</span>
                  <span class="high-light" v-html="value._highlight.business_scope[0]"></span>
                </div>
              </div>
            </baseinfo-card>
          </ul>
