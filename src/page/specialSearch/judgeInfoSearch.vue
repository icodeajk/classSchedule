  ...
  <div style='height:100%'>
    ...
    <div class="title">
      <header-switch>
        ...
        <mt-search v-model="searchVal" slot="center" class="inner-search" cancel-text="取消" placeholder="请输入企业名称、案件名称">
        </mt-search>
      </header-switch>
    </div>
    ...
    <scroll-view class="container" :pullup="true" @scrollToEnd="onPullingUp">
      <div>
        <div class="card-container">
          <ul class="list-ul">
            <event-card v-for="(value, index) in data" :key="index" :item="value" :eventType="'judgeInfo'">
              <div slot="bottom" class="list-bottom">
                ...
                <div class="bottom-right">
                  <span>被告：</span>
                  <span class="high-light" v-if="value.bidCompany">{{value.bidCompany}}</span>
      ...
      this.filterBarArr = [
        {
          ...
          key: 'caseType',
          list: [
            { name: '民事案件', key: '民事', active: false },
            { name: '刑事案件', key: '刑事', active: false },
            { name: '行政案件', key: '行政', active: false },
          ]
        }
      ]
    },
