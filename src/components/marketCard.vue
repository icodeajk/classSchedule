<template>
  <div class="card-container">
    <div class="title" v-if="title">
      <mt-cell :title="title" :to="{ path: '/marketList', query: company?{ company: company}:''}" is-link value="">
      </mt-cell>
    </div>
    <ul class="list-ul">
      <li class="list-li" v-for="(item,index) in data" :key="index">
        <router-link :to="{ path: 'eventDetail', query: { type: item.sub_type_en_name , id: index , navActive: navActive}}" @click.native="storeEvent(eventType)">
          <div class="list-cont">
